...
import com.example.ticketmaker.Utils.StringUtils;
...
//                            list.add( DataForSendToPrinterPos58.initializePrinter());
    ...
    private void printPIC(){
        ...
        Intent i = new Intent(getBaseContext(), TicketTemplate.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==0&&resultCode==RESULT_OK){
            Log.e("test1", data.getStringExtra("path"));
            ...
            switch (msg.what){
                ...
                case 2:
                    ...
                    if (PosPrinterDev.PortType.USB!=MainActivity.portType){
                        //showSnackbar("bitmap  "+b2.getWidth()+"  height: "+b2.getHeight());
                        //b2=resizeImage(b2,560,false);
                        printpicCode(b2);
                    }else {
                        /*showSnackbar("bitmap 1 "+b2.getWidth()+"  height: "+b2.getHeight());
...
*/
    ...
    public static Bitmap resizeImage(Bitmap bitmap, int w,boolean ischecked)
    {
        ...
        if (!ischecked) {
            ...
            //.70F Normal     .50F Motorola
            float scaleHeight = (((float) newHeight) / height);// * .50F; //.50F //for Motorola
